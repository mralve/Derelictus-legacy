...
{
    public class BMapSaveAs : BerryWindow
    {
        public override void WindowCreate(int sizeX, int sizeY, GameObject windowRef)
        {
            ...
            uiMapName.uiButtonText.uiText = MapDataManager.mapDataFileName;
            ...
            uiMapName.uiButtonText.uiText = MapDataManager.mapDataFilePath;
            ...
            BSaveMapAs curBSaveMapAs = UiManager.CreateButton(windowRef, saveButton).gameObject.AddComponent<BSaveMapAs>();
        ...
        public override string WindowGrabName()
        {
            ...
            return windowShortName = "Save Map As";
        }
    }

    public class BSaveMapAs : ActionComponent
    {
